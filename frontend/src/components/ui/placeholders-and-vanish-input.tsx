...
export function PlaceholdersAndVanishInput({
    ...
    return (
        <form
            className={cn(
                "w-full relative max-w-xl mx-auto bg-zinc-900 h-12 rounded-full overflow-hidden shadow-[0_0_1px_1px_rgba(239,68,68,0.2)] transition duration-200",
                value && "bg-zinc-950"
            )}
        ...
        >
            ...
            <button
                disabled={!value}
                type="submit"
                className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-zinc-800 bg-primary transition duration-200 flex items-center justify-center"
            >
                <motion.svg
