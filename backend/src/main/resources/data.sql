...
-- Uses MERGE to avoid duplicates on restart with file-based persistence

-- Standard Locations
MERGE INTO donation_locations (name, type, address, latitude, longitude, contact_info, opening_hours, start_date, end_date)
KEY (name)
VALUES
